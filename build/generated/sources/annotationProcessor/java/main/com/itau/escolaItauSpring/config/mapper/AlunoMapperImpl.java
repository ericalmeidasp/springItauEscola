...
@Generated(
    ...
    date = "2022-09-01T18:13:28-0300",
    comments = "version: 1.5.2.Final, compiler: IncrementalProcessingEnvironment from gradle-language-java-7.5.jar, environment: Java 11.0.16.1 (Amazon.com Inc.)"
)
@Component
public class AlunoMapperImpl implements AlunoMapper {
    ...
    public Aluno toModel(AlunoRequest alunoRequest) {
        ...
        aluno.setEndereco( enderecoRequestToModel( alunoRequest.getEndereco() ) );
    ...
    @Override
    public CursoResponse cursoModelToResponse(Curso curso) {
        if ( curso == null ) {
            return null;
        }
    ...
    @Override
    public Curso cursoRequestToModel(CursoRequest cursoRequest) {
        ...
        curso.setProfessor( professorRequestToModel( cursoRequest.getProfessor() ) );

        return curso;
    }

    @Override
    public Endereco enderecoRequestToModel(EnderecoRequest enderecoRequest) {
    ...
    @Override
    public Nota notaRequestToModel(NotaRequest notaRequest) {
        if ( notaRequest == null ) {
            return null;
        }
    ...
    @Override
    public Professor professorRequestToModel(ProfessorRequest professorRequest) {
    ...
    protected List<Nota> notaRequestListToNotaList(List<NotaRequest> list) {
        ...
        for ( NotaRequest notaRequest : list ) {
            list1.add( notaRequestToModel( notaRequest ) );
        }
    ...
    protected List<Curso> cursoRequestListToCursoList(List<CursoRequest> list) {
        ...
        for ( CursoRequest cursoRequest : list ) {
            list1.add( cursoRequestToModel( cursoRequest ) );
        }
